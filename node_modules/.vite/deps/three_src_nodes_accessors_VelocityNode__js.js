...
function* getNodeChildren(node, toJSON = false) {
  for (const property2 of Object.getOwnPropertyNames(node)) {
  ...
  build(builder, output2 = null) {
    ...
    if (buildStage === "setup") {
      ...
      if (result === "" && output2 !== null && output2 !== "void" && output2 !== "OutputType") {
        console.error(`THREE.TSL: Invalid generated code, expected a "${output2}".`);
...
var VelocityNode_default = VelocityNode;
var velocity = nodeImmutable(VelocityNode);
export {
  VelocityNode_default as default,
  velocity
};
//# sourceMappingURL=three_src_nodes_accessors_VelocityNode__js.js.map
